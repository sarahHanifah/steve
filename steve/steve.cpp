...
int main()
{
    ...
    float vertices2[] = {
        ...
        // depan
        -0.16f, -0.16f, -0.08f,     0.054f, 0.682f, 0.682f, // BL
        0.0f, -0.16f, -0.08f,       0.054f, 0.682f, 0.682f, // BR
        0.0f, 0.0f, -0.08f,         0.054f, 0.682f, 0.682f, // TR
        0.0f, 0.0f, -0.08f,         0.054f, 0.682f, 0.682f, // TR
        -0.16f, 0.0f, -0.08f,       0.054f, 0.682f, 0.682f, // TL
        -0.16f, -0.16f, -0.08f,     0.054f, 0.682f, 0.682f, // BL
        ...
        // kiri
        -0.16f, -0.16f, -0.08f,     0.054f, 0.682f, 0.682f, // BL
        -0.16f, -0.16f, 0.08f,      0.054f, 0.682f, 0.682f, // BR
        -0.16f, 0.0f, 0.08f,        0.054f, 0.682f, 0.682f, // TR
        -0.16f, 0.0f, 0.08f,        0.054f, 0.682f, 0.682f, // TR
        -0.16f, 0.0f, -0.08f,       0.054f, 0.682f, 0.682f, // TL
        -0.16f, -0.16f, -0.08f,     0.054f, 0.682f, 0.682f, // BL
        // kanan
        0.0f, -0.16f, 0.08f,        0.054f, 0.682f, 0.682f, // BL
        0.0f, -0.16f, -0.08f,       0.054f, 0.682f, 0.682f, // BR
        0.0f, 0.0f, -0.08f,         0.054f, 0.682f, 0.682f, // TR
        0.0f, 0.0f, -0.08f,         0.054f, 0.682f, 0.682f, // TR
        0.0f, 0.0f, 0.08f,          0.054f, 0.682f, 0.682f, // TL
        0.0f, -0.16f, 0.08f,        0.054f, 0.682f, 0.682f, // BL
        // bawah
        -0.16f, -0.16f, -0.08f,     0.054f, 0.682f, 0.682f, // BL
        0.0f, -0.16f, -0.08f,       0.054f, 0.682f, 0.682f, // BR
        0.0f, -0.16f, 0.08f,        0.054f, 0.682f, 0.682f, // TR
        0.0f, -0.16f, 0.08f,        0.054f, 0.682f, 0.682f, // TR
        -0.16f, -0.16f, 0.08f,      0.054f, 0.682f, 0.682f, // TL
        -0.16f, -0.16f, -0.08f,     0.054f, 0.682f, 0.682f, // BL
        // atas
        -0.16f, 0.0f, -0.08f,       0.054f, 0.682f, 0.682f, // BL
        0.0f, 0.0f, -0.08f,         0.054f, 0.682f, 0.682f, // BR
        0.0f, 0.0f, 0.08f,          0.054f, 0.682f, 0.682f, // TR
        0.0f, 0.0f, 0.08f,          0.054f, 0.682f, 0.682f, // TR
        -0.16f, 0.0f, 0.08f,        0.054f, 0.682f, 0.682f, // TL
        -0.16f, 0.0f, -0.08f,       0.054f, 0.682f, 0.682f, // BL
        ...
        0.0f, -0.16f, -0.08f,       0.662f, 0.490f, 0.392f, // TR
        0.0f, -0.16f, -0.08f,       0.662f, 0.490f, 0.392f, // TR
        -0.16f, -0.16f, -0.08f,     0.662f, 0.490f, 0.392f, // TL
        -0.16f, -0.48f, -0.08f,     0.662f, 0.490f, 0.392f, // BL
        ...
        -0.16f, -0.16f, 0.08f,      0.662f, 0.490f, 0.392f, // TR
        -0.16f, -0.16f, 0.08f,      0.662f, 0.490f, 0.392f, // TR
        -0.16f, -0.16f, -0.08f,     0.662f, 0.490f, 0.392f, // TL
        -0.16f, -0.48f, -0.08f,     0.662f, 0.490f, 0.392f, // BL
        // kanan
        ...
        0.0f, -0.16f, -0.08f,       0.662f, 0.490f, 0.392f, // TR
        0.0f, -0.16f, -0.08f,       0.662f, 0.490f, 0.392f, // TR
        0.0f, -0.16f, 0.08f,        0.662f, 0.490f, 0.392f, // TL
        0.0f, -0.48f, 0.08f,        0.662f, 0.490f, 0.392f, // BL
        // bawah
        -0.16f, -0.48f, -0.08f,     0.662f, 0.490f, 0.392f, // BL
        0.0f, -0.48f, -0.08f,       0.662f, 0.490f, 0.392f, // BR
        ...
        -0.16f, -0.48f, -0.08f,     0.662f, 0.490f, 0.392f, // BL
        // atas
        -0.16f, -0.16f, -0.08f,     0.662f, 0.490f, 0.392f, // BL
        0.0f, -0.16f, -0.08f,       0.662f, 0.490f, 0.392f, // BR
        0.0f, -0.16f, 0.08f,        0.662f, 0.490f, 0.392f, // TR
        0.0f, -0.16f, 0.08f,        0.662f, 0.490f, 0.392f, // TR
        -0.16f, -0.16f, 0.08f,      0.662f, 0.490f, 0.392f, // TL
        -0.16f, -0.16f, -0.08f,     0.662f, 0.490f, 0.392f // BL
    ...
    float vertices3[] = {
        ...
        // depan
        -0.16f, -0.4f, -0.08f,      0.286f, 0.274f, 0.592f, // BL
        0.0f, -0.4f, -0.08f,        0.286f, 0.274f, 0.592f, // BR
        ...
        // kiri
        -0.16f, -0.4f, -0.08f,      0.286f, 0.274f, 0.592f, // BL
        -0.16f, -0.4f, 0.08f,       0.286f, 0.274f, 0.592f, // BR
        -0.16f, 0.0f, 0.08f,        0.286f, 0.274f, 0.592f, // TR
        -0.16f, 0.0f, 0.08f,        0.286f, 0.274f, 0.592f, // TR
        -0.16f, 0.0f, -0.08f,       0.286f, 0.274f, 0.592f, // TL
        -0.16f, -0.4f, -0.08f,      0.286f, 0.274f, 0.592f, // BL
        // kanan
        0.0f, -0.4f, 0.08f,         0.286f, 0.274f, 0.592f, // BL
        0.0f, -0.4f, -0.08f,        0.286f, 0.274f, 0.592f, // BR
        0.0f, 0.0f, -0.08f,         0.286f, 0.274f, 0.592f, // TR
        0.0f, 0.0f, -0.08f,         0.286f, 0.274f, 0.592f, // TR
        ...
        -0.16f, -0.4f, -0.08f,      0.286f, 0.274f, 0.592f, // BL
        0.0f, -0.4f, -0.08f,        0.286f, 0.274f, 0.592f, // BR
        0.0f, -0.4f, 0.08f,         0.286f, 0.274f, 0.592f, // TR
        0.0f, -0.4f, 0.08f,         0.286f, 0.274f, 0.592f, // TR
        -0.16f, -0.4f, 0.08f,       0.286f, 0.274f, 0.592f, // TL
        -0.16f, -0.4f, -0.08f,      0.286f, 0.274f, 0.592f, // BL
        // atas
        ...
        // depan
        -0.16f, -0.48f, -0.08f,     0.419f, 0.419f, 0.419f, // BL
        0.0f, -0.48f, -0.08f,       0.419f, 0.419f, 0.419f, // BR
        0.0f, -0.4f, -0.08f,        0.419f, 0.419f, 0.419f, // TR
        0.0f, -0.4f, -0.08f,        0.419f, 0.419f, 0.419f, // TR
        -0.16f, -0.4f, -0.08f,      0.419f, 0.419f, 0.419f, // TL
        -0.16f, -0.48f, -0.08f,     0.419f, 0.419f, 0.419f, // BL
        ...
        0.0f, -0.4f, 0.08f,         0.419f, 0.419f, 0.419f, // TR
        0.0f, -0.4f, 0.08f,         0.419f, 0.419f, 0.419f, // TR
        -0.16f, -0.4f, 0.08,        0.419f, 0.419f, 0.419f, // TL
        -0.16f, -0.48f, 0.08f,      0.419f, 0.419f, 0.419f, // BL

        // kiri
        -0.16f, -0.48f, -0.08f,     0.419f, 0.419f, 0.419f, // BL
        -0.16f, -0.48f, 0.08f,      0.419f, 0.419f, 0.419f, // BR
        -0.16f, -0.40f, 0.08f,      0.419f, 0.419f, 0.419f, // TR
        -0.16f, -0.40f, 0.08f,      0.419f, 0.419f, 0.419f, // TR
        -0.16f, -0.40f, -0.08f,     0.419f, 0.419f, 0.419f, // TL
        -0.16f, -0.48f, -0.08f,     0.419f, 0.419f, 0.419f, // BL
        // kanan
        0.0f, -0.48f, 0.08f,        0.419f, 0.419f, 0.419f, // BL
        0.0f, -0.48f, -0.08f,       0.419f, 0.419f, 0.419f, // BR
        0.0f, -0.40f, -0.08f,       0.419f, 0.419f, 0.419f, // TR
        0.0f, -0.40f, -0.08f,       0.419f, 0.419f, 0.419f, // TR
        0.0f, -0.40f, 0.08f,        0.419f, 0.419f, 0.419f, // TL
        0.0f, -0.48f, 0.08f,        0.419f, 0.419f, 0.419f, // BL
        // bawah
        -0.16f, -0.48f, -0.08f,     0.419f, 0.419f, 0.419f, // BL
        0.0f, -0.48f, -0.08f,       0.419f, 0.419f, 0.419f, // BR
        0.0f, -0.48f, 0.08f,        0.419f, 0.419f, 0.419f, // TR
        0.0f, -0.48f, 0.08f,        0.419f, 0.419f, 0.419f, // TR
        -0.16f, -0.48f, 0.08f,      0.419f, 0.419f, 0.419f, // TL
        -0.16f, -0.48f, -0.08f,     0.419f, 0.419f, 0.419f, // BL
        // atas
        -0.16f, -0.40f, -0.08f,     0.419f, 0.419f, 0.419f, // BL
        0.0f, -0.40f, -0.08f,       0.419f, 0.419f, 0.419f, // BR
        0.0f, -0.40f, 0.08f,        0.419f, 0.419f, 0.419f, // TR
        0.0f, -0.40f, 0.08f,        0.419f, 0.419f, 0.419f, // TR
        -0.16f, -0.40f, 0.08f,      0.419f, 0.419f, 0.419f, // TL
        -0.16f, -0.40f, -0.08f,     0.419f, 0.419f, 0.419f // BL
